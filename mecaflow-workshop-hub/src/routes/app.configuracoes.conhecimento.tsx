        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="space-y-2">
              ...
              <Input required value={data.name} onChange={set("name")} />
            </div>
            <div className="space-y-2">
              <Label>CNPJ</Label>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                <Label>UF</Label>
                <Input value={data.state ?? ""} onChange={set("state")} maxLength={2} />
              </div>
            </div>
            <div className="space-y-2">
              <Label>CEP</Label>
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Textarea rows={4} value={data.services ?? ""} onChange={set("services")} placeholder="Troca de óleo, alinhamento, balanceamento..." />
            </div>
            <div className="space-y-2">
